  ...
  const projects = [
    {
      ...
      role:
        "Analyse de l'existant et des besoins, choix des technologies, conception et développement de l'application.",
      features: [
      ...
      technologies: ["Spring Boot", "PostgreSQL", "React", "Python"],
    },
    {
      title: "Sudoku Solver",
      ...
      role:
        "Conception de l'application et développement des algorithmes de résolution ainsi que de l'interface utilisateur.",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Organisation des tâches récurrentes",
      ],
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <a
                ...
                className="mt-6 inline-flex w-fit items-center gap-2 font-sans text-sm font-semibold text-blue-600 transition-colors duration-200 hover:text-blue-700"
              >
                Voir le projet
